        ...
        if search_books_videos:
            ...
            for material in materials:
                response_data.append({
                    ...
                    "cover_url": f"{base_url}/uploads/{material.cover_url.lstrip('/')}" if material.cover_url else None,
                    "file_url": f"{base_url}/uploads/{material.file_url.lstrip('/')}" if material.file_url else None,
        ...
        if search_courses:
            ...
            for c in courses:
                ...
                if c.cover_url:
                    ...
                    course_cover = f"{base_url}/static/covers/default_course.png"
